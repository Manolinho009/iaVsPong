...
#Cria̤̣o da classe que faz a cria̤̣o da Rede Neural.
class IA:
    #Cria uma rede com 2 entradas, 7 neuronios na camada oculta e 1 saida
    rede = buildNetwork (2,7, 1)

    #Crio uma "base" de dados onde coloco possiveis resultados corretos para compara̤̣o
...
VERDE = 0,255,0
VERMELHO= 255,0,0
#Cria̤̣o dos objetos que contem a tela
tamanho= 1080,600
...
#classe contendo informa̵̤es da raquete
class Raquete:
    ...
    #Atualiza as informa̵̤es da raquete na tela
    def realiza(self):
    ...
    #Atualiza o retangulo na tela e ler a a̤̣o do teclado
...
#Classe que contem informa̵̤es da bola
class Bola :
    ...
    #e treinamendo de novas gera̤oes
        ...
        if self.imagem_retangulo.x < 0 or self.imagem_retangulo.x > tela_retangulo.right - self.largura:
            ...
            if self.imagem_retangulo.x < 0:
                ...
                if placar.pontos <= 0:
                    ...
                    gen += 1
                    geracao.gen += gen
                    print("Re Treinado Grera̤̣o", gen)
                    placar.pontos = 2
    ...
    #Verifica a a̤̣o de colidir com a raquete
